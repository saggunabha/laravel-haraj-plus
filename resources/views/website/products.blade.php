...
<script type="application/ld+json">
{
 ...
 "image":"{{isset($category)?asset('storage/'.$category->image):''}}",
 "hasCategoryCode": {
        "@type": "CategoryCode",
        "name": "{{isset($category)?$category->name:''}}",
        "description": "{{isset($category)?$category->name:''}}",
        "inCodeSet": "{{ isset($category)?$category->id:''  }}"
        }
}
</script>
@endsection
                                    ...
                                    <div class="product-div">
                                        ...
                                        <a  href="{{route('product-details',$product->id.'-'.$product->name)}}">
                                            ...
                                            <div class="product-details">
                                                ...
                                                <h3 class="product-name first_color">{{strpos($product->name, '%') !== false ? str_replace("%","/",$product->name) : $product->name }} </h3>
