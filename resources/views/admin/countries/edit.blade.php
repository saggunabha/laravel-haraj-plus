    ...
    <div class="row">
        ...
        <div class="col-md-12 clients-grid margin-bottom-div">
            <div class="main-white-box">
                <h3 class="sec-title color-title"><span>تعديل دولة</span></h3>
                @include('alert')
                <form class="needs-validation row border-form" id="myform" novalidate="" action="{{route('countries.update', $country->id)}}" method="post">
                    {{ method_field('PATCH') }}                     {{ csrf_field() }}


                    <div class="form-group  col-md-6">
                        <label>الإسم<span class="starrisk">*</span></label>
                        <input type="text" class="form-control" name="name" id="name"  placeholder="الإسم" value="{{$country->name}}" required>
